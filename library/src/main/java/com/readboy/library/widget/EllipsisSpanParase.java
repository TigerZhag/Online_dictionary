 ...
 */
public class EllipsisSpanParase implements IParaser{
    ...
    public void setEllipsisMax(int maxChars) {
        this.maxChars = maxChars;
    }

    public EllipsisSpanParase(AnalysisInfo analysisInfo) {
                            ...
                            while (leave != 0) {
                                ...
                                if (offset > 0) {
                                    ...
                                    if (sufIndex > end) {
                                        ...
                                        if (preIndex != start) {
                                            if ((countChars + preIndex - start) >= maxChars) {
                                                addCharsInfoToLine(ii, start,
                                                        maxChars - countChars, textWidth, textHeight);
                                                countChars = maxChars;
                                                break;
                                            } else {
                                                addCharsInfoToLine(ii, start,
                                                        preIndex - start, textWidth, textHeight);
                                                countChars += preIndex - start;
                                            }
                                        }
                                        ...
                                        if ((countChars + end + 1 -start) >= maxChars) {
                                            addCharsInfoToLine(ii, start,
                                                    maxChars - countChars, textWidth, textHeight);
                                            countChars = maxChars;
                                            break;
                                        } else {
                                            countChars += end + 1 -start;
                                            addCharsInfoToLine(ii, start,
